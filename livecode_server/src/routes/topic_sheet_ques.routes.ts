...
import { createTopic, createSheet, createQuestion,addQuestionsToSheet, getAllQuestions,getAllSheets,getAllTopics,getTopicByTitle,getQuestionByTitle, getSheetByTitle,getQuestionsById, updateQuestion,updateSheet,updateTopic, deleteQuestion,deleteSheet,deleteTopic, getTopMatchRandmonQuestion } from '../controllers/topic_sheet_ques.controllers';
...
router.get('/question/:slug', getQuestionByTitle);
router.get('/question-by-id/:id',validParams, getQuestionsById);
router.get('/random-question',getTopMatchRandmonQuestion);
