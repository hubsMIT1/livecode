...
import {updateEntity, getEntityByTitle,deleteEntity,createEntity, createIncludeEntity, getEntityById} from '../utils/helper'
...
export const createQuestion = async (req: Request, res: Response) => {
  await createIncludeEntity(req, res, 'question', ['topic', 'image']);
};
...
export const addQuestionsToSheet = async (req: Request, res: Response) => {
  ...
  try{
    ...
    res.status(201).json({ message: 'Questions added to sheet', count: sheetQuestions.count });
  }catch(error:any){
...
export const getAllTopics = async (req: Request, res: Response) => await paginate(req,prisma.topic, res);
export const getAllSheets = async (req: Request, res: Response) => await paginate(req, prisma.sheet, res);
export const getAllQuestions = async (req: Request, res: Response) => await paginate(req, prisma.question, res);
